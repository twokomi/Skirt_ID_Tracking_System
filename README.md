...
### **모드 2: 위치 추적 시스템** 📍
- **URL**: https://fd3b4b1c.webapp-3sm.pages.dev/tracking
- **목적**: 트레이서빌리티 강화, 작업물 위치 이동 추적
- **기능**: 
  - Location + Skirt QR 스캔 → D1 저장 → 이력 조회
  - **NEW**: 최근 스캔 이력 20건 테이블로 실시간 표시
...
- **상태**: ✅ 프로덕션 배포 완료
- **메인 URL**: https://fd3b4b1c.webapp-3sm.pages.dev
- **MES Helper URL**: https://fd3b4b1c.webapp-3sm.pages.dev/mes-helper
- **위치 추적 URL**: https://fd3b4b1c.webapp-3sm.pages.dev/tracking
...
### **1. 메인 페이지 (모드 선택)**
모바일 브라우저로 접속:
- https://fd3b4b1c.webapp-3sm.pages.dev
...
### **2. MES Helper 테스트**
- https://fd3b4b1c.webapp-3sm.pages.dev/mes-helper
...
### **3. 위치 추적 테스트**
- https://fd3b4b1c.webapp-3sm.pages.dev/tracking
